export default function ArticleIII() {
  return (
    <div className="">
      <h1 className="font-(family-name:--font-cinzel) text-5xl font-bold uppercase max-sm:text-center">
        Article III — Flowing Soul
      </h1>
      <p className="mt-4 px-6 font-(family-name:--font-playfair) text-base leading-relaxed text-pretty first-letter:float-left first-letter:mt-1 first-letter:mr-1 first-letter:text-6xl first-letter:leading-[1]">
      ...
      <p className="mt-4 px-6 font-(family-name:--font-playfair) text-base leading-relaxed text-pretty">
        ...
        Write your goals. <br />
        Ask with Intelligence, faith, clear and specific. <br />
        Believe.
      </p>
      <p className="mt-4 px-6 font-(family-name:--font-playfair) text-base leading-relaxed text-pretty">
        You can always return to the old ways if nothing changes. But you won&#39;t want to because
        you&#39;ll feel the shift.
      </p>
      <p className="mt-4 px-6 font-(family-name:--font-playfair) text-base leading-relaxed text-pretty underline">
