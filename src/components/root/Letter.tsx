  ...
  return (
    ...
    >
      <div className="relative flex h-[95%] w-[95%] flex-col items-center justify-between border-2 border-dotted border-[var(--dark-border)] py-2">
        ...
        <div
          ref={kanjiRef}
          className="pointer-events-none absolute top-1/2 left-1/2 z-0 -translate-x-1/2 -translate-y-1/2 text-[clamp(12rem,35vw,35rem)] text-nowrap opacity-40 select-none"
        >
          手紙
        </div>
      </div>
