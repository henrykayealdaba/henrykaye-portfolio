...
export default function AudioAndMarqueeAndResume() {
  ...
  return (
    <>
      ...
      />
      <div ref={containerRef} className="flex w-screen overflow-hidden p-2 max-md:flex-col">
        <div
          ref={audioPlayerRef}
          className="author-transition-left-out flex w-full items-center justify-center"
        >
          <AudioPlayer picture={'duck3.jpg'} audioUrl="Kyatto - Lamp.mp3" />
        </div>
        <div
          ref={marqueeNavRef}
          className="author-transition-right-out mt-4 flex w-full flex-col max-md:items-center"
        >
          <Marquee
            fromX="0%"
            toX="-34.25%"
