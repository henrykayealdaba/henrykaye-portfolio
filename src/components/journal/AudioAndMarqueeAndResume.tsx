    ...
    <>
      ...
      <div className="flex w-screen flex-row-reverse overflow-hidden p-2 max-md:flex-col">
        ...
        >
          <AudioPlayer
            picture={'duck4.jpg'}
            audioUrl="しゃろう - カエルの勇者 @ フリーBGM DOVA-SYNDROME OFFICIAL YouTube CHANNEL.mp3"
          />
        </div>
        <div
          ref={marqueeNavRef}
          className="journal-transition-left-out mt-4 flex w-full flex-col max-md:items-center md:mr-1.5"
        >
          <Marquee
            fromX="0%"
            toX="-34.25%"
