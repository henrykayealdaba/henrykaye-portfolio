...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      >
        <span className="block max-md:text-center">Words are</span>
        <span className="block max-md:text-center">hard, But I</span>
        <span className="block max-md:text-center">Try Anyway</span>
      </span>
    </div>
  );
}
